...
# Script pour initialiser l'environnement Docker complet (avec Prometheus et Grafana)
...
echo -e "${YELLOW}docker-compose -f docker-compose.full.yml up -d${NC}"
